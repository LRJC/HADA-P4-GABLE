                    ...
                    <div class="row">
                        <div class="col-12 col-lg-8 px-0 px-lg-2">
                            ...
                            <div class="row py-3 align-items-center">
                                ...
                                <div class="col-4 font-weight-bold" style="color: black; text-align:center;">Parkase Parchis</div>
                                <div class="col-2" style="color: #5e5e5e!important; text-align:center;">5,99€</div>
                                <div class="col-2" style="color: #5e5e5e!important; text-align:center;">2</div>
                                <div class="col-2" style="color: #5e5e5e!important; text-align:center;">11,98€</div>
                            </div>
                            <!-- Producto 2 -->
                            <div class="row py-3 align-items-center">
                                <div class="col-2"><asp:ImageButton id="ImageButton1" runat="server" ImageUrl="src/parchis-example.png" Height="100"/></div>
                                <div class="col-4 font-weight-bold" style="color: black; text-align:center;">Parkase Parchis</div>
                                <div class="col-2" style="color: #5e5e5e!important; text-align:center;">5,99€</div>
                                <div class="col-2" style="color: #5e5e5e!important; text-align:center;">2</div>
                                <div class="col-2" style="color: #5e5e5e!important; text-align:center;">11,98€</div>
                        ...
                        <div class="col-12 col-lg-4 leftborder-lg pl-0 pl-lg-5 pt-3 pt-lg-0">
                            ...
                            <div id="total_price_div" class="row">
                                <p class="h4 font-weight-bold pr-2" style="color:black!important;">TOTAL:</p> <p id="total_price" class="h4 font-weight-bold" style="color:#5e5e5e!important;">23.96€</p>
                            </div>
                            <div class="row">
